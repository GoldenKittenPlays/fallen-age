...
public class ModPlacedFeatures {
    public static final ResourceKey<PlacedFeature> DRY_PLACED_KEY = registerKey("dry_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, DRY_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.DRY_KEY),
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(3, 0.1f, 2),
                        ModBlocks.DRY_SAPLING.get()));
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(FallenAge.MOD_ID, name));
    }
