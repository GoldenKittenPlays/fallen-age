package me.goldenkitten.fallen_age.world_gen;
...
public class ModConfiguredFeatures {
    public static final ResourceKey<ConfiguredFeature<?, ?>> DRY_KEY = registerKey("dry");
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, DRY_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(ModBlocks.DRY_LOG.get()),
                new DryTrunkPlacer(5, 4, 3),
                BlockStateProvider.simple(ModBlocks.DRY_LEAVES.get()),
                new DryFoliagePlacer(ConstantInt.of(3), ConstantInt.of(2), 3),
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(FallenAge.MOD_ID, name));
    }
